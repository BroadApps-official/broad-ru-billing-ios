...
private extension BroadPaymentMethodSheet {
    func methodTitle(_ method: CheckoutMethod) -> String {
        if let supplied = copy.checkout.methodTitles[method] {
            return supplied
        }
        switch method {
        case .sbp: return ruConfiguration.copy.sbpTitle
        case .card: return ruConfiguration.copy.cardTitle
        default: return copy.checkout.title(for: method)
        }
    }
